...
import { Plus, CalendarDays, Cog } from "lucide-react";
import { createStripeConnectLoginLink } from "@/actions/createStripConnectLoginLink";
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">
                <div className="flex justify-center gap-4">
                  <Link
                    ...
                    className="flex items-center gap-2 bg-blue-600 text-white text-[15px] px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors"
                  >
